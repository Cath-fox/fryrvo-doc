---
title: Fryrvo, Inc Docs
description: Get started building your docs site with Starlight.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: fryrvo docs for all stupid stuff cath has made 
  image:
    file: https://cdn.fryrvo.com/assets/fryrvo/fryrvo.png
  actions:
    - text: Example Guide
      link: /guides/example/
      icon: right-arrow
    - text: Read the Starlight docs
      ...
      icon: https://cdn.fryrvo.com/assets/fryrvo/fryrvo.png
      variant: minimal
---
